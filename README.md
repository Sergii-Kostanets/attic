...
* Bug: backend validation of phone number on checkout page. Every attempt to add backend validation failed. After adding backend validation payment doesn't work. Temporary solution: added frontend validation with disabling *Complete Order* button.
